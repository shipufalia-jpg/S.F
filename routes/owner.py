...
# ALL CHAMBERS LIST
# =========================
@owner.route("/chambers")
@owner_required
def chambers_list():

    chambers = Chamber.query.order_by(Chamber.id.desc()).all()
...
# EDIT CHAMBER
# =========================
@owner.route("/chamber/<int:chamber_id>/edit", methods=["GET", "POST"])
@owner_required
def edit_chamber(chamber_id):
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("owner.chambers_list"))
...
# =========================
# BLOCK / UNBLOCK CHAMBER
# =========================
@owner.route("/chamber/<int:chamber_id>/block")
@owner_required
...
@owner.route("/chamber/<int:chamber_id>/unblock")
@owner_required
...
# =========================
# DELETE CHAMBER (HARD DELETE)
# =========================
@owner.route("/chamber/<int:chamber_id>/delete")
@owner_required
